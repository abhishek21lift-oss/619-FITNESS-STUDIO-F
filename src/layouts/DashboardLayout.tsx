  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] text-[#1C1C1E] flex">
      ...
      <div className="flex-1 flex flex-col lg:ml-64">
        <header className="sticky top-0 z-30 flex items-center gap-3 h-12 px-3 lg:px-5 bg-white/90 backdrop-blur-xl border-b border-apple-blue/10">
          ...
          <div className="flex items-center gap-2">
            <span className="text-[10px] text-apple-gray-400 hidden sm:block">{user?.name || 'User'}</span>
            <button onClick={() => { clearToken(); window.location.href = '/fitness-center/login' }}
              className="flex items-center gap-1 px-2 py-1 text-[10px] text-apple-gray-400 hover:text-apple-red hover:bg-apple-red/10 rounded-lg transition-all">
