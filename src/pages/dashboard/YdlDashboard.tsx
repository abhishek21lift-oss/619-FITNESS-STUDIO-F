    ...
    <div className="p-4 lg:p-6 space-y-5">
      ...
      <div className="p-3 rounded-xl bg-gradient-to-r from-ydl-yellow/10 via-amber-600/10 to-ydl-yellow/5 border border-ydl-yellow/20">
        <p className="text-xs font-medium text-ydl-yellow">
          ...
          <a href="#" className="underline underline-offset-2 hover:text-ydl-yellow-light">Click here to activate</a>
        </p>
      </div>
        ...
        <div className="divide-y divide-ydl-dark-border/50">
          {summaryRows.map((row) => (
            <div key={row.label} className="flex items-center justify-between px-4 py-2.5 hover:bg-white/[0.02] transition-colors">
              ...
              {row.href ? (
                <a href={row.href} className="text-[11px] font-medium text-ydl-yellow hover:text-ydl-yellow-light underline underline-offset-2">
                  {row.value}
                </a>
              ) : (
      ...
      <div className="flex items-center justify-between pt-2 pb-4">
        ...
        <a href="#" className="text-[10px] text-gray-600 hover:text-ydl-yellow transition-colors">
          Download Anydesk
        </a>
      </div>
    </div>
