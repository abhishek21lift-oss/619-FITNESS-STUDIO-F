...
import { AlertTriangle, DollarSign, Calendar, Users, Plus, Search, Download } from 'lucide-react'
  ...
  return (
    <div className="p-4 lg:p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div><h1 className="text-lg font-bold text-white">Expired Memberships</h1><p className="text-xs text-gray-500 mt-0.5">Members with lapsed subscriptions.</p></div>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Add Expired Entry" size="md">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              <label className="text-[11px] font-medium text-gray-400">Start</label>
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-medium text-gray-400">End</label>
