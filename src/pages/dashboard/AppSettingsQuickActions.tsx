  ...
  return (
    <div className="p-4 lg:p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div><h1 className="text-lg font-bold text-[#1C1C1E]">Quick Actions</h1><p className="text-xs text-apple-gray-500 mt-0.5">Customize the quick action bar buttons.</p></div>
        <button onClick={() => navigate('/dashboard/app-settings/quick-actions/create')} className="flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-black bg-apple-gradient-blue rounded-lg hover:opacity-90">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-apple-gray-200 bg-white/[0.03]">
              ...
              <th className="text-left px-4 py-3 text-[10px] font-semibold text-apple-gray-500 uppercase">Action Name</th>
              <th className="text-left px-4 py-3 text-[10px] font-semibold text-apple-gray-500 uppercase">Icon</th>
              <th className="text-left px-4 py-3 text-[10px] font-semibold text-apple-gray-500 uppercase">Route</th>
              <th className="text-left px-4 py-3 text-[10px] font-semibold text-apple-gray-500 uppercase">Status</th>
              <th className="text-center px-4 py-3 text-[10px] font-semibold text-apple-gray-500 uppercase">Order</th>
            ...
            {actions.map((a, i) => {
              ...
              return (
                <motion.tr key={a.id} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.03 }} className="hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-4 py-3 text-xs font-medium text-[#1C1C1E]">{a.name}</td>
                  <td className="px-4 py-3"><Icon className="w-4 h-4 text-apple-blue" /></td>
                  ...
                  <td className="px-4 py-3 text-center text-xs text-apple-gray-400">#{a.order}</td>
