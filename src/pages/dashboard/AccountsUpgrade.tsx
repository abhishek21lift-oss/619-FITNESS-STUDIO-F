...
import { TrendingUp, DollarSign, Users, Plus, Search, Download } from 'lucide-react'
  ...
  return (
    <div className="p-4 lg:p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div><h1 className="text-lg font-bold text-white">Plan Upgrades</h1><p className="text-xs text-gray-500 mt-0.5">Members who upgraded their plans.</p></div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <StatsCard label="Additional Revenue" value={fmt(totalUpgradeRevenue)} icon={DollarSign} color="from-blue-500/20 to-blue-600/5" border="border-blue-500/30" text="text-blue-400" />
      </div>
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title={editItem ? 'Edit Upgrade' : 'Add Upgrade'} size="md">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-3 border-t border-ydl-dark-border">
            <button onClick={handleSave} className="px-4 py-2 text-xs font-semibold text-black bg-ydl-gradient rounded-lg hover:opacity-90">{editItem ? 'Update' : 'Add Upgrade'}</button>
