    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F5F5F7] px-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-2xl font-bold text-[#1C1C1E]">Login as Staff / Admin</h1>
          <p className="text-sm text-apple-gray-400 mt-1">Access your gym management dashboard</p>
        </div>
